...
This specification defines the consistency requirements for agent-scoped control APIs when reading and mutating agent-level configuration across tenant boundaries.
